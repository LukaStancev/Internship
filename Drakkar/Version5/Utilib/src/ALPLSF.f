...
*----
      ...
      DOUBLE PRECISION AA(MAXPTS,MAXPTS),BB(MAXPTS),GAR,PARAM(MAXPTS),
     1 AGAR(0:MAXNOR),BGAR(0:MAXNOR),CGAR(0:MAXNOR+1),V(MAXPTS,MAXPTS),
     2 W(MAXPTS),RV1(MAXPTS),SGN,GAROLD,YAPPR,RNORM,RMAX
