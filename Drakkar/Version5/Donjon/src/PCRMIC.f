...
*  ALLOCATABLE ARRAYS
*----
      INTEGER, ALLOCATABLE, DIMENSION(:) :: IMIX2,MILVO,IMICR
...
*----
      ALLOCATE(HUSE1(3,MAXISO),IMIX2(MAXISO),HUSE2(3,MAXISO),
     1 HNAM2(3,MAXISO),MILVO(NMIX),IPLIST(MAXISO))
...
*----
     ...
     1  MAXISO
      ...
      DO 80 I0=1,3
   80 HNAM2(I0,NBISO2)=HUSE1(I0,ISO)
      IMIX2(NBISO2)=IBM
   90 DENS2(NBISO2)=DENIS(ISO)
...
*----
      ...
      DEALLOCATE(IPLIST,MILVO,HNAM2,HUSE2,IMIX2,HUSE1)
      RETURN
      END
