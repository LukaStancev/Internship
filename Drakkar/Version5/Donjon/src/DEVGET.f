*DECK DEVGET
      SUBROUTINE DEVGET(JPDEV,NROD,LIMIT,IMPX)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
      ...
      IF(LEVEL.GE.0.0) THEN
        DO 40 IPART=1,NPART
        DO 40 I=1,6
   40   RODPOS(I,IPART)=MAXPOS(I,IPART)
        IF(IMODE.EQ.1) THEN
*         FADING ROD
...
*
 ...
 1005 FORMAT(5X,'INSERTION SPEED =',1X,1P,E10.4)
 1006 FORMAT(5X,'INSERTION TIME  =',1X,1P,E10.4)
