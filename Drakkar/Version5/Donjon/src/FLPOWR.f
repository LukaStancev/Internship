...
*----
      ...
      DO 10 JGR=1,NGRP
   10 PTOT=PTOT+FLUX(IEL,JGR)*VOL(IEL)*HFAC(MAT(IEL),JGR)
   20 CONTINUE
      PAVG=REAL(PTOT/VTOT)
...
*----
   ...
   70 RETURN
*
 1000 FORMAT(/1X,'MAX POWER =',1X,1PE12.6,1X,'WATTS',4X,
     1 'AT COORD :',1X,'I =',I3,2X,'J =',I3,2X,'K =',I3/)
 1001 FORMAT(1X,'COMPUTED TOTAL POWER :',1X,1PE14.8,1X,'WATTS'/
     1 1X,'MEAN POWER DENSITY',3X,':',1X,1PE14.8,1X,'WATTS/CM3')
 1002 FORMAT(6(1X,1PE14.8))
