...
*----
     ...
     1    //'. L_MACROLIB EXPECTED.')
        ...
        DO 20 IED=1,NED
   20   HMAK1(8+IED)=HVECT(IED)
        DO 30 IL=1,NL
        WRITE(CM,'(I2.2)') IL-1
   30   HMAK1(8+NED+IL)='SIGS'//CM
        HMAK2(1)='NUSIGF'
        HMAK2(2)='CHI'
        DO 40 IDEL=1,NDEL
...
*----
      ...
      IF(IACCS.EQ.0) THEN
        ...
        DO 130 IED=1,NED
  130   HMAK1(8+IED)=HVECT(IED)
        DO 140 IL=1,NL
        WRITE(CM,'(I2.2)') IL-1
  140   HMAK1(8+NED+IL)='SIGS'//CM
        HMAK2(1)='NUSIGF'
        HMAK2(2)='CHI'
        DO 150 IDEL=1,NDEL
        WRITE(TEXT8,'(6HNUSIGF,I2.2)') IDEL
  ...
  170 CONTINUE
      IF(ISTATE(4).GT.0) THEN
        ...
        IF(ILONG.NE.0) THEN
          ...
          DO 174 I=1,NF
          IOF=(IBMOLD-1)*NF+I
  174     GAR2(IBM,I,IGR,I2D)=GAR2(IBM,I,IGR,I2D)+WEIGHT*FLOT(IOF)
        ENDIF
  175   CONTINUE
      ENDIF
      DO 190 IL=1,NLTMP
