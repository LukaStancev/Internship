...
*
*Purpose:
*  SAVE MIXTURE PROCESSING OPTIONS ON CPO
*
*Author(s): 
* G.MARLEAU
*
...
* ITITL   INTEGER VECTOR CONTAINING TITLE          I(18)
* LSUBT   LENGTH OF SUBTITLE                       I
* ISUBT   INTEGER VECTOR CONTAINING SUB-TITLE      I(LSUBT)
* ENECPO  CPO ENERGY GROUP STRUCTURE               R(NGCCPO+1)
