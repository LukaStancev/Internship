...
*----
      ...
      DO 10 JGR=1,NGRP
   10 FLXB(ICH,IB,JGR)=FLXB(ICH,IB,JGR)+FLUX(IEL,JGR)*VOL(IEL)
...
*     FLUXES RATIOS
      ...
      DO 50 ICH=1,NCH
      DO 50 JGR=1,NGRP-1
   50 RATIO(ICH,IB,JGR)=FLXB(ICH,IB,JGR)/FLXB(ICH,IB,NGRP)
      IF(.NOT.LMAP)GOTO 80
*----
*  PRINTING
*----
