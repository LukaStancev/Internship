...
*
*Parameters: input
* POSTRI  spatial description of the triangle
...
*         \begin{itemize}
*         \item \verb|NXTITA|=0 means that there is no intersection
*         between the two regions;
*         \item \verb|NXTITA|=1 means that the hexagon
*         is all located inside the annular pin;
*         \item \verb|NXTITA|=2 means that the annular pin
*         is all located inside the hexagon;
*         \item \verb|NXTITA|=-1 means that the intersection between
