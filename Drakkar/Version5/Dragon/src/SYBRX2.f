...
*
      ...
      IF(IKG.EQ.JKG) THEN
         DO 70 J=1,J2
         DO 70 I=1,J2
   70    P(I1+I,I1+J)=PIJW(IPIJ+(J-1)*J2+I)
      ENDIF
   90 I1=I1+I2
   95 IPIJ=IPIJ+J2*J2
*----
...
*----
  ...
  120 PSSB(J1,IKK)=PSSB(J1,IKK)-ZZZ*ALBEDO
...
*----
      ...
      J2=NMC(JKG+1)-J1P
      DO 130 J=1,J2
  130 P(I1+I,J1+J)=P(I1+I,J1+J)+ZZZ*PSSB(JKK,NMERGE+IKK)*PSJW(J1P+J)
  140 J1=J1+J2
  150 I1=I1+I2
*----
