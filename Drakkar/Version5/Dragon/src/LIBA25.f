...
*----
      ...
      DO 10 IG1=1,NGRO
   10 SCAT(IG2,IG1,1)=SCAT(IG2,IG1,1)/SIGS(IG1,1)
*----
...
*        COMPUTE THE EFFECTIVE FLUX.
   ...
   30    TMP1=TMP1+SCAT(L,IG2,1)*SIGS(IG2,1)*DELTA(IG2)/DELTA(L)
...
*           USE A SLOWING-DOWN BALANCE EQUATION.
   ...
   40       TMP=TMP+SCAT(L,IG2,1)*TAUX(IG2-FGHOMO+1,2)/DELTA(L)
...
*----
      IF(LDIF) THEN
         DO 60 IG1=1,NGRO
         DO 60 IG2=1,NGRO
   60    SCAT(IG2,IG1,1)=SCAT(IG2,IG1,1)*SIGS(IG1,1)
         INGRO=NL-1
         DO 70 IL=NL-1,0,-1
   ...
   80    DO 100 IL=1,NL-1
         IF(ITYPRO(IL+1).GT.0) THEN
            ...
            DO 90 IG1=1,NGRO
   90       SCAT(IG2,IG1,IL+1)=SCAT(IG2,IG1,IL+1)*SIGS(IG1,1)/VECT(IG1)
         ENDIF
  100    CONTINUE
*----
