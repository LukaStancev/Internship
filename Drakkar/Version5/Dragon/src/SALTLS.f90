...
!
!Parameters: input
! IFTEMP  pointer to a temporary tracking data structure in creation mode.
! IPRINT  print level.
...
!         a direction dependent normalization of the tracks for the volume
!         while a value reno=0, implies a global normalisation.
! NBDR    number of directions for track normalization. reno=1: no
!         normalization.
