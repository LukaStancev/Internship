!!!!!!!!!!
!
!fichier g2s_segArc.md9
!
!  module segArc
!  #############
! C'est dans ce module que sont gerees toutes les fonctions relatives aux
...
10  continue
  ...
  subroutine cutClusters(nbRing,nbClus,szSa)
    ...
    taille_table_temp = nbRing*nbClus*2 !ca me semble suffisant (note de l'auteur )
