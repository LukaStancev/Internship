...
*----
   ...
   80 VOL(I)=0.0
      ...
      DO 90 IS=1,NSECT
      IND=NUMREG(IS,IR)
   90 VOL(IND)=VOL(IND)+VOLINT(IS,IR)
*----
...
*
  200 FORMAT(/49H SYB4TS: TRACKING OF A SECTORIZED CARTESIAN CELL./
     ...
     4 7H COTEA ,1P,E8.2,16H   (X-AXIS SIDE)/
     5 7H COTEB ,1P,E8.2,16H   (Y-AXIS SIDE)/
     6 7H DXMIN ,1P,E8.2,24H   (GEOMETRICAL EPSILON)/
     7 7H DELR  ,1P,E8.2,37H   (HALF DISTANCE BETWEEN THE TRACKS)/
