*DECK SNFT22
      SUBROUTINE SNFT22(LX,LY,IELEM,NMAT,NPQ,NSCT,MAT,VOL,TOTAL,NCODE,
...
* for the DISCONTINUOUS GALERKIN method. Albedo boundary conditions.
*
*Copyright:
...
*  LOCAL VARIABLES
*----
      DOUBLE PRECISION Q(IELEM**2),XNJ(IELEM),Q2(IELEM**2,(IELEM**2)+1),
     1 CONST0,CONST1,CONST2,CONST3,CONST4,CONST5,CORNERQ(IELEM**2)
