...
*----
      ...
      DOUBLE PRECISION, ALLOCATABLE, DIMENSION(:) :: Q,CORNERQ
...
*----
     ...
     >         -U(IP)*AFB
            ...
            Q2(2,1) = -3**(0.5D0)*U(IP) 
            Q2(2,2) = TOTAL(IBM)*VOL(I) - 3*U(IP) 
            Q2(2,3) = 2*15**(0.5D0)*U(IP) - 3**(0.5D0
     >         )*5**(0.5D0)*U(IP) 
            Q2(3,1) = -5**(0.5D0)*U(IP) 
     ...
     >         )*5**(0.5D0)*U(IP) 
            ...
            Q2(3,2) = -3**(0.5D0)*5**(0.5D0)*U(IP) 
            Q2(3,3) = TOTAL(IBM)*VOL(I) - 5*U(IP) 
            Q2(3,4) = 2*35**(0.5D0)*U(IP) - 5**(0.5D0
     >         )*7**(0.5D0)*U(IP) 
            Q2(4,1) = -7**(0.5D0)*U(IP) 
            ...
            IF(IELEM.EQ.1)THEN
            CORNERQ(1) = Q2(1,IELEM+1)
            CORNERQ(2) = Q2(1,IELEM+1)
            ELSEIF(IELEM.EQ.2)THEN
            CORNERQ(1) = Q2(1,IELEM+1) +
     >         Q2(2,IELEM+1)*(-SQRT(3.0D0)) 
            CORNERQ(2) = Q2(1,IELEM+1) + 
     >         Q2(2,IELEM+1)*(SQRT(3.0D0))
            ELSEIF(IELEM.EQ.3)THEN
            CORNERQ(1) = Q2(1,IELEM+1) + 
     >         Q2(2,IELEM+1)*(-SQRT(3.0)) + 
     >         Q2(3,IELEM+1)*(SQRT(5.0)) 
            CORNERQ(2) = Q2(1,IELEM+1) + 
     >         Q2(2,IELEM+1)*(SQRT(3.0)) + 
     >         Q2(3,IELEM+1)*(SQRT(5.0)) 
            ELSEIF(IELEM.EQ.4)THEN
            CORNERQ(1) = (Q2(01,IELEM+1) - 3**(0.5D0)*Q2(02,IELEM+1) 
     >         + 5**(0.5D0)*Q2(03,IELEM+1) - 7**(0.5D0)*Q2(04,IELEM+1)) 
            CORNERQ(2) = (Q2(01,IELEM+1) + 3**(0.5D0)*Q2(02,IELEM+1) 
     >         + 5**(0.5D0)*Q2(03,IELEM+1) + 7**(0.5D0)*Q2(04,IELEM+1)) 
            ENDIF
            AFB=CORNERQ(1)
  930    CONTINUE
...
*----
     ...
     >         U(NLF-IP+1)*AFB
            ...
            Q2(2,1) = -3**(0.5D0)*U(NLF-IP+1) 
            Q2(2,2) = 3*U(NLF-IP+1) + TOTAL(IBM)*VOL(I) 
            Q2(2,3) = 2*15**(0.5D0)*U(NLF-IP+1) - 3**(0.5D0
     >         )*5**(0.5D0)*U(NLF-IP+1) 
     ...
     >      )*5**(0.5D0)*U(NLF-IP+1) 
            ...
            Q2(3,2) = -3**(0.5D0)*5**(0.5D0)*U(NLF-IP+1) 
            Q2(3,3) = 5*U(NLF-IP+1) + TOTAL(IBM)*VOL(I) 
            Q2(3,4) = 2*35**(0.5D0)*U(NLF-IP+1) - 5**(0.5D0
     >         )*7**(0.5D0)*U(NLF-IP+1) 
