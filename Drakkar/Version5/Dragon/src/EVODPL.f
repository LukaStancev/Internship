...
*----
  ...
  140 IMA2(I)=IMA(I)
      DO 160 L=1,2
      DO 145 I=1,NVAR
  145 BDPL2(I,L)=BDPL(I,L)
      DO 150 I=1,IMA(NVAR)
  150 ADPL2(I,L)=ADPL(I,L)
      DO 160 I=1,NFISS
      DO 160 J=1,NSUPF
  160 YSF2(I,J,L)=YSF(I,J,L)
      NVAR2=NVAR
      NSUPF2=NSUPF
      DO 180 ITER=1,NTER
      I0=0
...
*----
  ...
  270    CONTINUE
     ...
     >   WRITE(6,'(34H MATRIX TRUNCATED TO 120 ELEMENTS.)')
      ...
      DO 280 I=1,NVAR2
      BDPL3(I,1)=BDPL2(I,1)
  280 BDPL3(I,2)=BDPL2(I,2)
      DO 290 I=1,NFISS
      DO 290 J=1,NSUPF2
      YSF3(I,J,1)=YSF2(I,J,1)
  290 YSF3(I,J,2)=YSF2(I,J,2)
...
*----
  ...
  320 IMA2(I)=IMA(I)
      DO 330 I=1,IMA(NVAR)
  330 ADPL2(I,2)=ADPL(I,2)
      DO 340 I=1,NFISS
      KFIS2(I)=KFISS(I)
      DO 340 J=1,NSUPF
  340 YSF2(I,J,2)=YSF(I,J,2)
      NVAR2=NVAR
      NSUPF2=NSUPF
      DO 360 ITER=1,NTER
      I0=0
