!!!!!!!
!
! fichier g2s_constType.md9
!
! Dans ce module, les types definis dans dragon sont definis a leur valeur
! sous forme de constantes litterales. (ameliore la lisibilite des algorithmes)
!
!!!!!!
