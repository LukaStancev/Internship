!!!!!!!
!
! fichier g2s_cellulePlaced.md9
!
!  module cellulePlaced
!  ####################
! Ce module definit un tableau de cellules pretes a etre exploitees. Les
! structures definies de type "t_cellulePlaced" possedent comme champs :
...
!  - chargerNewData : recuperations des donnees supplementaires crees a l'etape
!                     de pretraitement
