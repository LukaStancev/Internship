...
*----
     ...
     1 SCAT(1,1,1,IDIL),ITYPRO)
      DO 30 IL=0,NL-1
   30 LSCAT(IL+1)=LSCAT(IL+1).OR.(ITYPRO(IL+1).GT.0)
      DO 50 IED=1,NED
      DO 40 IG1=1,NGRO
   40 SADD(IG1,IED,IDIL)=0.0
...
*----
   ...
   90 CONTINUE
      ...
      DO 100 IG2=1,NGRO
  100 SCAT(IG2,IG1,IL,IDIL)=SCAT(IG2,IG1,IL,IPDIL(IDIL))
      DO 110 IED=1,NED
  110 SADD(IG1,IED,IDIL)=SADD(IG1,IED,IPDIL(IDIL))
      DO 120 IDEL=1,NDEL
  120 ZDEL(IG1,IDEL,IDIL)=ZDEL(IG1,IDEL,IPDIL(IDIL))
*----
