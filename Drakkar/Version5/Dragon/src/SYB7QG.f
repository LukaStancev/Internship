...
*----
   ...
   60 VOL(I)=0.0
      ...
      DO 70 IS=1,NSECT
      IND=NUMREG(IS,IR)
   70 VOL(IND)=VOL(IND)+VOLINT(IR)/6.0
*----
...
*----
  ...
  190 PVS(INC(6,IH),I)=SGN*PSIX(1,IH,I)
      DO 200 I=1,6*NCURR
      DO 200 J=1,6*NCURR
  200 PSS(I,J)=0.0
      DO 210 IH=1,NCURR
  ...
  210 PSS(INC(5,IH),INC(6,JH))=QSS(INQ(JH,IH,1))/HSIDE
*----
