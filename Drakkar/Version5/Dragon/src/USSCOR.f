...
*----
   ...
   20 CONTINUE
      ...
      DO 30 IND=1,NBNRS
   30 DIL(IND,IND,I1)=DIL(IND,IND,I1)-SIGR(IND)
*----
...
*           COMPUTE THE FULLY CORRELATED PIJ MATRIX.
            ...
            DO 100 I1=1,NQT1
            DO 40 IND=1,NBNRS
   40       SIGR(IND)=CONR(IND,IRES)*TOTPT(I1,IRES)
            KPSYS=LCMGIL(IPSYS,IASM+I1)
     ...
     1      TOTPT(1,JRES),PIJ3(0,0),DIL(0,0,I1))
            ...
            DO 60 I=0,NBNRS
            DO 60 J=0,NBNRS
   60       PIJ2(I,J)=DIL(I,J,I1)
            DO 70 I=1,NBNRS
   70       PIJ2(I,I)=PIJ2(I,I)+SIGR(I)+CONR(I,JRES)*TOTPT(I2,JRES)
            IF(LMOD) THEN
            ...
            DO 80 I=0,NBNRS
            DO 80 J=0,NBNRS
   80       PIJ3(I,J)=PIJ3(I,J)+WWW*PIJ2(I,J)
*
...
*
            ...
            DO 150 I=0,NBNRS
            DO 150 J=0,NBNRS
  150       PIJ2(I,J)=DILW(I,J)
            DO 160 I=1,NBNRS
  160       PIJ2(I,I)=PIJ2(I,I)+SIGR(I)+CONR(I,JRES)*TOTPT(I2,JRES)
            IF(LMOD) THEN
               CALL ALINV(NBNRS,PIJ2(1,1),NBNRS+1,IER)
            ELSE
               CALL ALINV(NBNRS+1,PIJ2(0,0),NBNRS+1,IER)
            ...
            DO 170 I=0,NBNRS
            DO 170 J=0,NBNRS
  170       PIJ3(I,J)=PIJ3(I,J)+WWW*PIJ2(I,J)
            KPSYS=LCMGIL(IPSYS,IASM+I1)
