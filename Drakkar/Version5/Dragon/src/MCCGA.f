...
*
*Purpose:
* calculation of PJJ for flux integration when isotropic scat. is
* considered
* calculation of preconditioning matrices for Algebraic Collapsing
* Acceleration or Self-Collision Probability acceleration of inner
* iterations. Vectorial version.
*
*Copyright:
