...
*      NETSUR   : number of surfaces for NXTRecords
*      NETVOL   : number of regions for NXTRecords
*      NUNN     : new number of unknowns
*      IMERGE   : merging index
*      MATO     : old albedos/material indices
*      VOLO     : old surface/volume
*      MATRTO   : old BC identification (BC-REFL+TRAN)
*Parameters: output
*      MAXMN    : new maximum mixture number
*      MATN     : new albedos/material indices
*      VOLN     : new surface/volume
*      KEYN     : new flux indices
*      MATRTN   : new BC identification (BC-REFL+TRAN)
