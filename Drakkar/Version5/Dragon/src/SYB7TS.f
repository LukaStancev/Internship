...
*----
   ...
   80 VOL(I)=0.0
      ...
      DO 90 IS=1,NSECT
      IND=NUMREG(IS,IR)
   90 VOL(IND)=VOL(IND)+VOLINT(IR)/6.0
*----
...
*
  200 FORMAT(/49H SYB7TS: TRACKING OF A SECTORIZED HEXAGONAL CELL./
     ...
     4 7H HSIDE ,1P,E8.2,17H   (HEXAGON SIDE)/
     5 7H DXMIN ,1P,E8.2,24H   (GEOMETRICAL EPSILON)/
     6 7H DELR  ,1P,E8.2,37H   (HALF DISTANCE BETWEEN THE TRACKS)/
