!fichier g2s_constUtil.md9
!
!  module constUtiles
!  ##################
! Dans ce module sont definies des constantes globales utilisees dans tout les
! modules. De plus, quelques fonctions utilitaires sont aussi definies, telles
! que :
...
!
!CS-IV : TO DO : presenter les nouvelles routines 
...
!  double precision,parameter  :: epsilon  = 5.d-5
