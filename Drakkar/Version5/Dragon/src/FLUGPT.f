*DECK FLUGPT
      SUBROUTINE FLUGPT(IPRT,IPFLUX,IPTRK,IPMACR,IPFLUP,IPGPT,IFTRAK,
...
* IPGPT   pointer to the GPT fixed source LCM object.
...
*----
      ...
      TYPE(C_PTR) IPFLUX,IPTRK,IPMACR,IPFLUP,IPGPT,IPSYS
...
*----
      ...
      REAL, ALLOCATABLE, DIMENSION(:,:) :: FLUXO,SOURO,XSTOT,XSTRC,
     > FXSOR,XSTK
...
*----
     ...
     > XSTRC(0:NMAT,NGRP),XSDIA(0:NMAT,0:NANIS,NGRP),FXSOR(0:NMAT,NGRP),
...
*
     ...
     4 VOL,XSTOT,XSTRC,XSDIA,FXSOR,XSNUF,XSCHI,LREBAL)
 1000 CONTINUE
*----
...
*----
      DEALLOCATE(VSCAT,XSTK,XSNUF,XSCHI,FXSOR,XSDIA,XSTRC,XSTOT,SOURO,
     > FLUXO)
      RETURN
*----
*  FORMATS
