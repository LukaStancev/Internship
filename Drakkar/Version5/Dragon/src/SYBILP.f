...
*        CHECK THE RECIPROCITY CONDITIONS.
   ...
   95    VOLTOT=VOLTOT+VOL(I)
         ...
         AAA=PP(I,J)*VOL(I)
         BBB=PP(J,I)*VOL(J)
  100    WRK=MAX(WRK,ABS(AAA-BBB)/VOLTOT)
...
*        CHECK THE CONSERVATION CONDITIONS.
         IF(.NOT.ILK) THEN
            ...
            DO 110 J=1,NREG
            AAA=PP(I,J)
  110       F1=F1-AAA*(SIGT(J)-SIGW(J))
  120       WRK=AMAX1(WRK,ABS(F1))
