...
*
     ...
     1   A12,2H''.)') TEXT12
         ...
         DO 20 IG1=1,NGRP
   20    GAR1(IG1)=PHGAR(IND,IRES,IG1)
         CALL LCMPUT(KPLI0,'NWT0',NGRP,2,GAR1)
         DO 30 IG1=1,NGRP
   30    GAR1(IG1)=SPH(IND,IRES,IG1)
         CALL LCMPUT(KPLI0,'NSPH',NGRP,2,GAR1)
         DO 40 IG1=1,NGRP
   40    GAR1(IG1)=STGAR(IND,IRES,IG1)
         CALL LCMPUT(KPLI0,'NTOT0',NGRP,2,GAR1)
         IF(LOGNF) THEN
            DO 50 IG1=1,NGRP
   50       GAR1(IG1)=SFGAR(IND,IRES,IG1)
         ...
         DO 60 IG2=1,NGRP
   60    GAR2(IG2,IG1)=S0GAR(IND,IRES,IL,IG2,IG1)
   ...
   90    CONTINUE
     ...
     2   (HVECT(IED)(:3).NE.'NWT').AND.(HVECT(IED).NE.'NTOT0')) THEN
            DO 100 IG1=1,NGRP
  100       GAR1(IG1)=SAGAR(IND,IRES,IED,IG1)
  ...
  120       LTEST=LTEST.OR.(GAR1(IG1).NE.0.0)
            IF(LTEST) THEN
