...
*
   ...
   10 AKINV=AKINV+XSNUF(MATCOD(IREG),IFIS,IGRP)*PHIC
   15 CONTINUE
*
...
*
      IF(AKINV.NE.0.0) THEN
         ...
         FISONE=DZERO
         DO 50 IGRP=1,NGRP
   50    FISONE=FISONE+XSNUF(IBM,IFIS,IGRP)*FLUX(IND,IGRP)
         DO 60 IGRP=1,NGRP
   60    SUMCHI=SUMCHI+AKINV*XSCHI(IBM,IFIS,IGRP)*FISONE*VOL(IREG)
   70    CONTINUE
      ENDIF
*
      PROD=SUMCHI*FISOUR
