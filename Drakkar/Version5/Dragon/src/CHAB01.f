...
*        application of the perturbation
         ...
         DO 10 IG1=1,NGRP
   10    XSECT(IG1)=XSECT(IG1)+DELTA(IG1)
...
*           application of the perturbation
            ...
            CALL LCMGET(IPLIB,'NTOT0',XSECT)
            DO 310 IG1=1,NGRP
  310       XSECT(IG1)=XSECT(IG1)+DELTA(IG1)
            CALL LCMPUT(IPLIB,'NTOT0',NGRP,2,XSECT)
         ENDIF
  320    CONTINUE
         TYPSEC='CAPT'
...
*        multiplicative modification of transport correction
         ...
         IF(ILONG.GT.0) THEN
            ...
            DO 20 IG1=1,NGRP
   20       XSECT(IG1)=XSECT(IG1)*FMULT(IG1)
...
*        additive modification of total cross section
         ...
         CALL LCMGET(IPLIB,'NTOT0',XSECT)
         DO 40 IG1=1,NGRP
   40    XSECT(IG1)=XSECT(IG1)+DELTA(IG1)
         CALL LCMPUT(IPLIB,'NTOT0',NGRP,2,XSECT)
...
*        additive modification of total cross section
         CALL LCMGET(IPLIB,'NTOT0',XSECT)
         DO 50 IG1=1,NGRP
   50    XSECT(IG1)=XSECT(IG1)+DELTA(IG1)
         CALL LCMPUT(IPLIB,'NTOT0',NGRP,2,XSECT)
*
*        additive modification of P0 scattering information
         IF (TYPSEC.EQ.'N2N') THEN
            DO 60 IG1=1,NGRP
   60       DELTA(IG1)=2.0*DELTA(IG1)
         ELSE IF (TYPSEC.EQ.'N3N') THEN
            DO 70 IG1=1,NGRP
   70       DELTA(IG1)=3.0*DELTA(IG1)
         ELSE IF (TYPSEC.EQ.'N4N') THEN
            DO 80 IG1=1,NGRP
   80       DELTA(IG1)=4.0*DELTA(IG1)
         ENDIF
         JMOD=3
         CALL CHAB04(IPLIB,IMPX,IRHS,NGRP,NLEG,JMOD,0,IGM,IGP,DELTA,
     1   DELTA,FMULT)
...
*        multiplicative modification of transport correction
         ...
         IF((IL.LE.1).AND.(ILONG.GT.0)) THEN
            ...
            CALL LCMGET(IPLIB,'TRANC',XSECT)
            DO 120 IG1=1,NGRP
  120       XSECT(IG1)=XSECT(IG1)*FMULT(IG1)
            CALL LCMPUT(IPLIB,'TRANC',NGRP,2,XSECT)
         ENDIF
*
*        additive modification of total cross-section
         IF(IL.EQ.0) THEN
            ...
            CALL LCMGET(IPLIB,'NTOT0',XSECT)
            DO 130 IG1=1,NGRP
  130       XSECT(IG1)=XSECT(IG1)+DELTA(IG1)
            CALL LCMPUT(IPLIB,'NTOT0',NGRP,2,XSECT)
         ENDIF
*
*        multiplicative modification of Pn scattering information with
*        n>IL
  ...
  210    CONTINUE
         CALL CHAB02(NGRP,IMOD,VALUE,IGM,IGP,VAL,XSECT,DELTA,FMULT)
         DO 220 IG1=1,NGRP
  220    XSECT(IG1)=GAR1(IG1)*XSECT(IG1)
         CALL LCMPUT(IPLIB,'NUSIGF',NGRP,2,XSECT)
      ELSE IF(TYPSEC.EQ.'CHI') THEN
         ...
         SUM=0.0
         DO 230 IG1=1,NGRP
  230    SUM=SUM+GAR1(IG1)
         DO 240 IG1=1,NGRP
  240    GAR1(IG1)=GAR1(IG1)/SUM
         CALL LCMPUT(IPLIB,TYPSEC,NGRP,2,GAR1)
      ELSE
