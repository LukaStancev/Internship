...
*     NAME     : PSPRAI
*     USE      : Find general closed Cartesian region intersections
...
* 2- PARAMETERS:
*  INPUT
*     MXSEG  : MAXIMUM NUMBER OF SEGMENTS              I
*     NPTS   : NUMBER OF CORNERS                       I
*     XYPOS  : X AND Y POSITION OF CORNERS             R(2,NPTS)
*     CENTER : X AND Y POSITION OF ANNULUS CENTER      R(2)
*     RCIRC  : ANNULUS RADIUS                          R
*  OUTPUT
*     NSEG   : NUMBER OF REGION INTERSECTION           I
*              NUMBER OF SEGMENTS IS NSEG-1
*     IORDER : TYPE OF REGION                          I(MXSEG)
*              = -2 : ARC SEGMENT BEGINS
*              = -1 : ARC SEGMENT ENDS
*              =  0 : CLOSE PATH
*              >  0 : CORNER
*     RADANG : SEGMENTS INTERSECTION POINTS            R(2,MXSEG)
