*DECK ASMDRV
     ...
     >                  LEAKSW,ITRANC,LDIFF,TITRE,ITPIJ,LNORM,IPHASE,
     >                  ISTRM,KNORM,NALBP)
*
*-----------------------------------------------------------------------
*
...
*----
     ...
     >            MATCOD(NREGIO),ITRANC,ITPIJ,IPHASE,ISTRM,KNORM,NALBP
      REAL        VOLUME(NREGIO)
*----
*  LOCAL VARIABLES
*----
      ...
      REAL, ALLOCATABLE, DIMENSION(:,:) :: XSSCOR,XSDIFF
      REAL, ALLOCATABLE, DIMENSION(:,:,:) :: XSSIGT,XSSIGW
...
*----
      DEALLOCATE(ALBP)
      DEALLOCATE(XSDIFF,XSSCOR,XSSIGW,XSSIGT)
      DEALLOCATE(NPSYS)
      RETURN
*----
*  FORMATS
