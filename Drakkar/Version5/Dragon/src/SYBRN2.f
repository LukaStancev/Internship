...
*----
  ...
  290 PBB(22+I)=(Z2*PBB(22+I)-Z3*DEN2)*Z4
      DO 300 J=1,NREG
      DEN1=PVS(7,J)
      DEN2=PVS(1,J)
      PVS(7,J)=Z1*Z1*DEN1
  ...
  300 PVS(2,J)=Z1*(Z2*PVS(2,J)-Z3*DEN2)
*
      Z1=0.0
      Z2=0.0
      Z4=0.0
