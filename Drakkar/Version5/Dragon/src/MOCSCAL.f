...
* integration.
* Linear-Discontinuous-Characteristics scheme with tabulated exponential
* calls.
...
*         track.
* SIGANG  macroscopic total cross section and albedos.
* NMU     order of the polar quadrature set.
* ZMU     inverse of polar quadrature cosines.
*
*Parameters: output
* DSIG    macroscopic total cross sections.
* EXPT    LDC coefficients (exponential term).
* EXP2    other LDC coefficients.
*
*-----------------------------------------------------------------------
*
      IMPLICIT NONE
