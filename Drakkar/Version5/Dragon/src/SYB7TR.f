...
* NZRR    length if the original real tracking information.
* ZZRR    original real tracking information.
* NZIR    length if the original integer tracking information.
* ZZIR    original integer tracking information.
*
*Parameters: output
* NZRR    length if the unfolded real tracking information.
* ZZRR    unfolded real tracking information.
* NZIR    length if the unfolded integer tracking information.
* ZZIR    unfolded integer tracking information.
*
*-----------------------------------------------------------------------
*
*----
