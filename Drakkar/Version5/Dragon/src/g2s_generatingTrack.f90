!!!!!
!
! fichier g2s_generatingTrack.md9
!
! Ce module sert a generer les donnees relatives aux gigognes de provenance des
! nodes, et aux numeros type dragon qu'elles auraient pris
!
! fonctions:
