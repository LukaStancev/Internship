...
*----
      ...
      IF(IEX.EQ.1) THEN
        ...
        DO 10 JGR=1,NGCOND
   10   SUM=SUM+SUNMER(IMERG,JGR,IGR)*FLXMER(IMERG,JGR)
        SUNKNO(IREG)=SUM
   20   CONTINUE
      ELSE
        DO 30 IREG=1,NREG
   ...
   25   SUM=SUM+FUNKNO(KEY(IREG),JGR)*GARS
        SUNKNO(IREG)=SUM
   30   CONTINUE
      ENDIF
*----
...
*        ASYMPTOTIC NORMALIZATION.
         ...
         DO 50 J=1,NREG
         JBM=MAT(J)
   50    WORK2(I,J)=-SIGMA(JBM)*WORK2(I,J)
   60    WORK2(I,I)=WORK2(I,I)+VOL(I)
...
*        INTEGRATED FLUX OR SELENGUT NORMALIZATION.
         ...
         DO 70 J=1,NREG
         JBM=MAT(J)
   70    WORK2(I,J)=-SIGMA(JBM)*WORK2(I,J)
   80    WORK2(I,I)=WORK2(I,I)+VOL(I)
         WORK2(NREG+1,NREG+1)=COURIN(IGR)*VOLTOT
      ENDIF
     ...
     1 NREG,WORK2(1,NREG+1),WORK2(1,NREG+1))
      ...
      DO 90 I=1,NREG
   90 FUNKNO(KEY(I),IGR)=REAL(WORK2(I,NREG+1))
  100 CONTINUE
*----
