...
*      NAME     : MRGXTC (MODIFIED MRGLIN)
*      USE      : Subdivide tracking file into 2 sets
*      MODIFIED : 97-11-06 (G.M),11-12-01 (J.R.)
*      AUTHOR   : G.MARLEAU
*
*  2- ROUTINE PARAMETERS:
*    INPUT
*      IFTRKO   : OLD TRACKING FILE          I
*      IFTRKN   : OLD PART R (RESIDUAL)
*                 TRACKING FILE              I
*      IFTRKE   : OLD PART E (EXTRACTED)
*                 TRACKING FILE              I
...
*      IMERGE   : MERGED POSITION            I(-NSOUTO:NVOUTO)
*
*---------------------------   MRGXTC --------------------------------
*
      IMPLICIT         NONE
