...
*
*Purpose:
* subroutine of SENS for the creation of sensitivity profiles to
...
*----
     ...
     1    30HNOT AVAILABLE IN THE MICROLIB.)') ISONAM,II
        ...
        IF(ILENG.GT.0) THEN
          CALL XDISET(NUSIGF,NG,0)
          CALL XDISET(CHI,NG,0)
