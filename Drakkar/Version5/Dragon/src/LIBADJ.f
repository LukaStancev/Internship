...
*----
   ...
   20 DO 50 IL=0,INGRO
      IF(ITYPRO(IL+1).GT.0) THEN
         ...
         DO 30 J=1,NGRO
   30    GA2(I,J)=SCAT(NGRO-J+1,NGRO-I+1,IL+1)
         DO 40 I=1,NGRO
         SIGS(I,IL+1)=GA1(I,1)
         DO 40 J=1,NGRO
   40    SCAT(NGRO-J+1,NGRO-I+1,IL+1)=GA2(J,I)
      ENDIF
   50 CONTINUE
