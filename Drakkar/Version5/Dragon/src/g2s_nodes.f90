!fichier g2s_nodes.md9
!
!  module ptNodes
!  ##############
! Module permettant la numerotation des regions definies par la geometrie.
! La numerotation est utilisee pour le jeux de donnees SALOME. Il faut donner un
! numero a chaque region definit par des arcs, des segments et/ou des cercles.
