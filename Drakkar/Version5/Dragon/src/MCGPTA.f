...
*         this 2D track.
* NZONA   index-number of the mixture type assigned to each volume for ACA.
...
* T2D     vector containing the local coordinates of the segments boundaries
*         for this 2D track.
* LTMT    track merging flag.
* SUBDS2  ACA coefficients summation subroutine.
* SUBDSP  ACA coefficients position subroutine.
* SUBDSC  ACA coefficients calculation subroutine.ons for this 2D track.
