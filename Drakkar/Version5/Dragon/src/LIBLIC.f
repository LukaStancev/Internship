*DECK LIBLIC
     ...
     2 INAME,NTFG,SN,SB,NIR,GIR,NGF,IGRMAX,NDEL,NBESP,IPROC)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
     ...
     > NBESP,IPROC,ISONAM(3,NBISO),ISONRF(3,NBISO),ISHINA(3,NBISO),
     > IHLIB(2,NBISO,3),ILLIB(NBISO),INAME(16,NLIB),NTFG(NBISO),
     > NIR(NBISO)
      LOGICAL MASKI(NBISO)
      CHARACTER*(*) HVECT(NED)
