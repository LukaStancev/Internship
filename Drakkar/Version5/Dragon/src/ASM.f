...
*
     ...
     1      3H VS,I4,15H) OR UNKNOWNS (,I5,3H VS,I6,2H).)') IPP(8),
     2      NGRP,IPP(9),NUN
            CALL XABORT(HSMG)
         ENDIF
         ITPIJ=IPP(1)
...
*----
     ...
     1 NREG,NANI,NANIST,NW,MAT,VOL,LEAKSW,ITRANC,LDIFF,TITRE,ITPIJ,
...
*----
      ...
      IF(IMPX.GE.1) THEN
         WRITE (IOUT,6040)IMPX,(IPP(I),I=1,3),(IPP(I),I=5,12)
         WRITE (IOUT,'(5H DOOR,11X,1H(,A,1H))') CDOOR
      ENDIF
      RETURN
*
 ...
 6040 FORMAT(/8H OPTIONS/8H -------/
     ...
     2 7H ITPIJ ,I6,30H   (1=WIJ/2=PIJ/3=WIJK/4=PIJK)/
     3 7H LNORM ,I6,34H   (0=NORMALIZE PIJ TO 1/1=DO NOT)/
     4 7H LALBS ,I6,36H   (0=RECOVER AND SAVE WIS/1=DO NOT)/
     5 7H IPHASE,I6,43H   (1=GENERAL FLUX SOLUTION/2=PIJ APPROACH)/
     6 7H ISTRM ,I6,44H   (1=HOMO BN OR NO LEAKAGE/2=ECCO/3=TIBERE)/
     7 7H KNORM ,I6,46H   (0=NO/1=GELBARD/2=DIAGONAL/3=NON-LINEAR/4=H,
     8 6HELIOS)/
     9 7H NGRP  ,I6,21H   (NUMBER OF GROUPS)/
     1 7H NUN   ,I6,23H   (NUMBER OF UNKNOWNS)/
     2 7H NBMIX ,I6,23H   (NUMBER OF MIXTURES)/
     3 7H NANI  ,I6,44H   (NUMBER OF LEGENDRE ORDERS SCATTERING XS)/
     4 7H IDIFF ,I6,47H   (0/1: DIFFUSION COEFFICIENTS ABSENT/PRESENT))
      END
