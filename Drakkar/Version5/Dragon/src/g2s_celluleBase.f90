!!!!!!!!
!
!fichier g2s_celluleBase.md9
!
!  module celluleBase
!  ##################
!
! Dans ce module, on cree un tableau de structures de type "t_celluleBase".
...
!!$  !tableau de celluleBase
!!$  type celluleBaseArray
!!$     type(t_celluleBase),pointer  :: p
!!$  end type celluleBaseArray
