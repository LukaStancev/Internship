...
*         ICOMB=-1, means that  one considers only the first
*         track set (Cartesian), ICOMB=-2, means one considers
*         only the second track set (annular), ICOMB=1, means that
*         the Cartesian and annular regions are super imposed while
*         preserving the outer Cartesian boundary and finally
*         ICOMB=2, means that the Cartesian and annular regions
