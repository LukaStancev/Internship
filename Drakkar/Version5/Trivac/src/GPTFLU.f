...
*         HENTRY(2): read-only type(L_GPT) => GPT fixed source
...
*----
     ...
     + //'ND TRACKING OBJECTS HAVE DIFFERENT NUMBER OF LINEAR ORDER')
      ...
      IF( GPTPRM(1).NE.NGRP )CALL XABORT('GPTFLU: L_GPT AND L_FLUX HAV'
     + //'E DIFFERENT NUMBER OF GROUPS')
      IF( GPTPRM(2).NE.NUN )CALL XABORT('GPTFLU: L_GPT AND L_FLUX HAVE'
     + //' DIFFERENT NUMBER OF UNKNOWS')
*----
*  READ USER INPUT:
*----
      IPRINT=0
