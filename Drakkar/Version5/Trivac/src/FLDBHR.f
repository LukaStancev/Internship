*DECK FLDBHR
     ...
     1 IMPX,MAXINR,EPSINR,TKT,TKB,GRAD1)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
      ...
      INTEGER LL4,ITY,NUN,NGRP,ICL1,ICL2,IMPX,MAXINR
...
*
  ...
  130 CONTINUE
      ...
      IF(IMPX.GT.1) WRITE(6,1000) ITER,GINN,EPSINR,IGDEB,ZMU,TEXT3
      IF(GINN.LT.EPSINR) GO TO 160
  150 CONTINUE
*----
