*DECK KINST2
     ...
     1 ICL2,NADI,MAXOUT,EPSOUT,MAXINR,EPSINR,FNAM,PNAM,IMPX,POWTOT)
*
*-----------------------------------------------------------------------
*
*Purpose:
...
*----
      ...
      ENDIF
      CALL KINDRV(NEN,KEN,CMOD,NGR,NBM,NBFIS,NDG,NLF,ITY,NEL,LL4,
     1 NUN,NUP,TTF,TTP,DT,IMPH,ICL1,ICL2,NADI,MAXOUT,EPSOUT,MAXINR,
...
*
 1001 FORMAT(/1X,5('--o--',5X)//8X,'PERFORMING KINETICS',
     ...
     2 'MENT',1X,'=',1X,1PE10.4,1X,'SEC'/8X,'ELAPSED TI',
     3 'ME',3X,'=',1X,1PE10.4,1X,'SEC')
