*DECK KINDRV
     ...
     1 LL4,NUN,NUP,TTF,TTP,DT,IMPH,ICL1,ICL2,NADI,MAXOUT,EPSOUT,MAXINR,
...
*----
     ...
     1 ITY,LL4B,NUN,NUP,PDC,TTF,TTP,DT,OVR,CHI,CHD,SGF,SGO,OMEGA,PHO,PC,
     2 SRC)
*----
...
*----
     ...
     1  IEXP,NBM,NBFIS,NDG,ICL1,ICL2,IMPX,IMPH,TITR,EPSOUT,MAXINR,
     2  EPSINR,NADI,MAXOUT,PDC,TTF,TTP,DT,OVR,CHI,CHD,SGF,SGD,OMEGA,
     3  EVECT,SRC)
      ENDIF
      DEALLOCATE(SRC)
*----
...
*----
     ...
     1 MAT,VOL,IDLPC,EVECT,PHO,SGD,SGO,PDC,DT,TTP,PC,IPR,IEXP,OMEGA,
     2 IMPX)
