...
#---
for file in list(glob.glob('../Serpent/*det0.m')):
    cbor = file.split('/')[-1].split('.')[0]
    ...
    corepower = UnfoldEighth(FoldEighth(corepower))
    # Remove all powers equal to zero
    powers[controlrod]['Serpent'] = corepower[np.nonzero(corepower)]
#---
