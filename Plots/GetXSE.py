...
def GetXSE(choice):
    ...
    for draglibpath in directories:
        ...
        #  N3N, N4N, NNP, N2A
        #---
        wished_reactions = {'NTOT0', 'NUSIGF', 'NINEL', 'N2N', 'NA', 'NP', 'ND', 'NG', 'NELAS', 'NFTOT', 'N3N', 'N4N', 'NNP', 'N2A', 'NE'}
    ...
    return Energies, XSs, reactions, iso, iso_list
